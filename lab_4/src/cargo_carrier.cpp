...
CargoCarrier::CargoCarrier(double cost, double speed, double travel_distance, std::string city_name)
    : cost_pr_km(cost), speed_km_h(speed), distance(travel_distance), city(std::move(city_name)) {
}
